...
> Fuente: https://felwiki.thefactoryhka.com.pa/nota_de_credito_generica
> **tipoDocumento = 06**

Nota de crédito **sin referencia** a una FE anterior. Se usa cuando no se puede vincular a una factura específica.

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `06` | **Nota de Crédito genérica** (sin CUFE referenciado) |
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>06</ser:tipoDocumento>
        ...
        <ser:informacionInteres>Factura de nota de credito</ser:informacionInteres>
        <ser:cliente>
