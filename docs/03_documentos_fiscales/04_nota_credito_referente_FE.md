...
> Fuente: https://felwiki.thefactoryhka.com.pa/nota_de_credito_referente_a_una_o_varias_fe
> **tipoDocumento = 04**

Nota de crédito que hace referencia explícita a una o más Facturas Electrónicas previamente emitidas (mediante su CUFE).

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `04` | **Nota de Crédito referente a una FE** |
| listaDocsFiscalReferenciados | OBLIGATORIO | Lista de CUFEs referenciados |

> ⚠️ **Bug histórico detectado en Sago One**: Credit notes emitidas con `tipoDocumento` incorrecto, `listaDocsFiscalReferenciados` faltante, y `tipoContribuyente` undefined. Verificar estos tres puntos al emitir notas referenciadas.

## Nodo `listaDocsFiscalReferenciados` requerido
...
<ser:listaDocsFiscalReferenciados>
  <ser:docFiscalReferenciado>
    ...
    <ser:cufeFEReferenciada>FE0120000155596713-2-2015-5900002020122900050000050010126666880485</ser:cufeFEReferenciada>
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>04</ser:tipoDocumento>
        <ser:numeroDocumentoFiscal>5000007</ser:numeroDocumentoFiscal>
        ...
        <ser:informacionInteres>Factura de nota de credito referenciada</ser:informacionInteres>
        <ser:cliente>
