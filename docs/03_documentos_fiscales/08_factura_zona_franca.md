...
> Fuente: https://felwiki.thefactoryhka.com.pa/factura_de_zona_franca
> **tipoDocumento = 08**

Factura emitida por empresas ubicadas en **Zonas Francas** de Panamá. Estructura idéntica a la Factura de Operación Interna salvo el `tipoDocumento`.

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `08` | **Factura de Zona Franca** |
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>08</ser:tipoDocumento>
        <ser:numeroDocumentoFiscal>5000011</ser:numeroDocumentoFiscal>
        ...
        <ser:informacionInteres>Factura Zona Franca</ser:informacionInteres>
        <ser:cliente>
