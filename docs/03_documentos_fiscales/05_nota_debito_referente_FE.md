...
> Fuente: https://felwiki.thefactoryhka.com.pa/nota_de_debito_referente_a_una_o_varias_fe
> **tipoDocumento = 05**

Nota de débito que hace referencia explícita a una o más Facturas Electrónicas previamente emitidas (mediante su CUFE). Estructura idéntica a la Nota de Crédito referenciada, solo cambia el `tipoDocumento`.

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `05` | **Nota de Débito referente a una FE** |
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>05</ser:tipoDocumento>
        <ser:numeroDocumentoFiscal>5000008</ser:numeroDocumentoFiscal>
        ...
        <ser:informacionInteres>Factura de nota de debito referenciada</ser:informacionInteres>
        <ser:cliente>
        ...
        <ser:listaDocsFiscalReferenciados>
          <ser:docFiscalReferenciado>
            ...
            <ser:cufeFEReferenciada>FE0120000155596713-2-2015-5900002020122900050000090010120993630685</ser:cufeFEReferenciada>
          </ser:docFiscalReferenciado>
        </ser:listaDocsFiscalReferenciados>
      </ser:datosTransaccion>
      <ser:listaItems>
