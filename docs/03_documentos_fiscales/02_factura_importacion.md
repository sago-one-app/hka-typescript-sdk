...
> Fuente: https://felwiki.thefactoryhka.com.pa/factura_de_importacion
> **tipoDocumento = 02**

Factura emitida para operaciones de importación. Diferencia clave: `naturalezaOperacion = 21` (Importación) vs `01` (Venta interna).

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `02` | Factura de importación |
| naturalezaOperacion | `21` | **Importación** (vs 01 = Venta) |
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>02</ser:tipoDocumento>
        <ser:numeroDocumentoFiscal>5000004</ser:numeroDocumentoFiscal>
        ...
        <ser:naturalezaOperacion>21</ser:naturalezaOperacion>
        ...
        <ser:informacionInteres>Factura importacion</ser:informacionInteres>
        <ser:cliente>
