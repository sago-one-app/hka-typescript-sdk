...
> Fuente: https://felwiki.thefactoryhka.com.pa/reembolso
> **tipoDocumento = 09**

Documento de Reembolso. Estructura idéntica a la Factura de Operación Interna, solo cambia el `tipoDocumento`.

## Campos clave distintivos

| Campo | Valor | Observación |
|---|---|---|
| tipoDocumento | `09` | **Reembolso** |
  ...
  <tem:Enviar>
    ...
    <tem:documento>
      ...
      <ser:datosTransaccion>
        ...
        <ser:tipoDocumento>09</ser:tipoDocumento>
        <ser:numeroDocumentoFiscal>5000012</ser:numeroDocumentoFiscal>
        ...
        <ser:informacionInteres>Factura Reembolso</ser:informacionInteres>
        <ser:cliente>
      ...
      <ser:listaItems>
        <ser:item>
          <ser:descripcion>Mesas</ser:descripcion>
